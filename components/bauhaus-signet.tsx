...
interface BauhausSignetProps {
  size?: number;
  showAnimation?: boolean;
}

export function BauhausSignet({ size = 200, showAnimation = true }: BauhausSignetProps) {
  ...
  return (
    <div className="flex justify-center items-center">
      <motion.div
        initial="initial"
        animate={loaded && showAnimation ? "animate" : "initial"}
      ...
      >
        ...
        >
          ...
          <motion.circle 
            ...
            animate={{ scale: 1, opacity: showAnimation ? 1 : 0 }}
